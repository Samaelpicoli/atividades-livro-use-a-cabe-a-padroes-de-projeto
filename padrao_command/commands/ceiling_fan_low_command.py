...
class CeilingFanLowCommand(Command):
    ...
    def __init__(self, ceiling_fan: CeilingFan):
        """
        Inicializa o comando para ligar o ventilador de teto
        na velocidade baixa.

        Args:
            ceiling_fan (CeilingFan): Instância do ventilador
            de teto a ser controlado.
        """
    ...
    def execute(self):
        """
        Executa o comando de ligar o ventilador na velocidade baixa.
        """
